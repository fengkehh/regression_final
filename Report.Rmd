...
## Model Selection
Since amf is a two-level factor coded with 0 and 1, it can be directly used as a predictor in MLR. Nested MLR fits are generated with increasing model complexities using the following code:

```{r nested_fit, echo = TRUE}
...
ANOVA-F test is then carried out.
